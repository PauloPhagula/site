...
Mock objects helps us move from state-based testing to interaction-based testing,
...
Using the created prophecy object we can specify how the an `Authorizer` object
...
for the `Authorizer` class. We know the SUT won't/should not interact with dummy
